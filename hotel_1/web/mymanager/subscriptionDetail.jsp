...
<div id="container">
    ...
    <div id="content" style="border:solid 1px #ffffff;width:90%;margin:auto;padding-top:10px">
        ...
        <div class="submit">
            <input type="button" value="返回" onclick="location='subscriptionList.jsp'"/>
        </div>
    </div>
    <hr/>
    <div id="footer">
