...
<div id="container">
    ...
    <div id="content">
        ...
        <div class="subcontent">
            <form action="${pageContext.request.contextPath}/SaveExitScriptionServlet">

                <fieldset>
                    <legend>联系人信息</legend>
                    <div>
                        <input type="hidden" name="no" id="no" value="${subscription.no}"/>
                        <label for="name">联系人</label>
                        <input type="text" name="name" id="name" value="${subscription.linkman}"/>
                    </div>
                    <div>
                ...
                <fieldset class="buttons">
                    <input type="button" value="取消" onclick="location='memberCenter.jsp'"/>
